                ...
                <div className="grid md:grid-cols-2 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <div className="space-y-8 pl-4 border-l-2 border-purple-500/20">
                            {EXPERIENCE.filter(e => e.role.includes("Intern") || e.role.includes("Developer")).map((exp, index) => (
                                <motion.div
                                    key={index}
                    ...
                    <div>
                        ...
                        <div className="space-y-8 pl-4 border-l-2 border-blue-500/20">
                            {EXPERIENCE.filter(e => e.role.includes("Student")).map((exp, index) => (
                                <motion.div
                                    key={index}
                                    initial={{ opacity: 0, x: -20 }}
                                    whileInView={{ opacity: 1, x: 0 }}
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        {ACHIEVEMENTS.map((ach, index) => (
                            <div key={index} className="p-6 bg-secondary/30 rounded-xl border border-yellow-500/20 hover:bg-secondary/50 transition-colors">
